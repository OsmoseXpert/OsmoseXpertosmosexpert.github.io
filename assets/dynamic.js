...
// Calendly popup (on-demand)
(function(){
  function openCalendly(){
    if (window.Calendly && window.Calendly.initPopupWidget){
      window.Calendly.initPopupWidget({ url: 'https://calendly.com/osmose-xpert-info/new-meeting' });
      return;
    }
    var s = document.createElement('script');
    s.src = 'https://assets.calendly.com/assets/external/widget.js';
    s.onload = function(){ window.Calendly && window.Calendly.initPopupWidget && window.Calendly.initPopupWidget({ url: 'https://calendly.com/osmose-xpert-info/new-meeting' }); };
